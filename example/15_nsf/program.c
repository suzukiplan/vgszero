...
void main(void)
{
    ...
    // メニューを表示
    vgs0_bg_putstr(8, 7, 0x80, "PLAY");
    vgs0_bg_putstr(8, 9, 0x80, "PAUSE");
    vgs0_bg_putstr(8, 11, 0x80, "RESUME");
    vgs0_bg_putstr(8, 13, 0x80, "FADEOUT");
    ...
    while (1) {
        ...
        if (!pushing && push) {
            ...
            switch (cursor) {
                ...
                case 9: vgs0_bgm_pause(); break;
                case 11: vgs0_bgm_resume(); break;
                case 13: vgs0_bgm_fadeout(); break;
            }
        }
    }
}
