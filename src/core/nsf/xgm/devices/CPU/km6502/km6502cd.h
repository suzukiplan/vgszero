...
static void OpsubCall KM_ALUADDER(__CONTEXT_ Uword src)
{
    ...
    __THIS__.P += FLAG_NZC(w) + ((((~__THIS__.A ^ src) & (__THIS__.A ^ w)) >> 1) & V_FLAG);
    __THIS__.A = RTO8(w);
}
...
/* --- ADC ---  */
#if BUILD_HUC6280
#define DEF_ADC(i, p, a)                                    \
    static void OpcodeCall Opcode##i(__CONTEXT)             \
    {                                                       \
